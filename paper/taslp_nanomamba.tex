...
\midrule
\multirow{3}{*}{Factory}
  & DS-CNN-S (23.8K)    & 96.8 & 64.9 & 74.6 & 86.5 & 91.5 & 94.0 & 95.1 & 95.9 \\
  & BC-ResNet-1 (7.5K)  & 95.3 & \textbf{65.7} & \textbf{75.0} & \textbf{83.6} & \textbf{89.4} & \textbf{92.2} & \textbf{93.0} & \textbf{93.9} \\
  & NM-DualPCEN (5.0K)  & 93.7 & 60.9 & 67.7 & 78.5 & 85.2 & 88.8 & 91.4 & 91.6 \\
\midrule
\multirow{3}{*}{White}
  & DS-CNN-S (23.8K)    & 96.8 & 61.4 & 66.5 & 81.8 & 90.0 & 93.1 & 94.7 & 95.6 \\
  & BC-ResNet-1 (7.5K)  & 95.3 & \textbf{59.3} & \textbf{64.5} & \textbf{77.3} & \textbf{85.7} & \textbf{90.2} & \textbf{92.7} & \textbf{93.8} \\
  & NM-DualPCEN (5.0K)  & 93.8 & 36.2 & 60.4 & 74.4 & 83.7 & 88.7 & 90.8 & 92.3 \\
\midrule
\multirow{3}{*}{Babble}
  & DS-CNN-S (23.8K)    & 96.8 & 77.0 & 85.3 & 90.7 & 94.2 & 95.5 & 96.1 & 96.5 \\
  & BC-ResNet-1 (7.5K)  & 95.3 & \textbf{76.3} & \textbf{84.4} & \textbf{89.1} & \textbf{91.9} & \textbf{93.7} & \textbf{94.7} & \textbf{94.7} \\
  & NM-DualPCEN (5.0K)  & 93.8 & 70.0 & 77.3 & 85.4 & 89.4 & 91.8 & 92.7 & 92.9 \\
\midrule
\multirow{3}{*}{Street}
  & DS-CNN-S (23.8K)    & 96.8 & 62.1 & 69.4 & 81.4 & 89.6 & 92.6 & 94.9 & 95.7 \\
  & BC-ResNet-1 (7.5K)  & 95.3 & \textbf{60.6} & \textbf{64.4} & \textbf{76.1} & \textbf{85.3} & \textbf{90.5} & \textbf{93.0} & \textbf{94.1} \\
  & NM-DualPCEN (5.0K)  & 93.7 & 58.4 & 62.7 & 74.0 & 82.1 & 87.8 & 90.5 & 92.2 \\
\midrule
\multirow{3}{*}{Pink}
  & DS-CNN-S (23.8K)    & 96.8 & 60.9 & 66.5 & 81.9 & 90.6 & 93.5 & 94.8 & 95.9 \\
  & BC-ResNet-1 (7.5K)  & 95.3 & \textbf{59.6} & \textbf{65.6} & \textbf{79.7} & \textbf{88.2} & \textbf{91.7} & \textbf{93.6} & \textbf{94.4} \\
  & NM-DualPCEN (5.0K)  & 93.7 & 24.1 & 57.1 & 76.3 & 84.9 & 89.5 & 91.9 & 93.2 \\
\bottomrule
\end{tabular}
\end{table*}
...
\midrule
DS-CNN-S (23.8K)    & 2.7 & 3.8 & 4.1 \\
BC-ResNet-1 (7.5K)  & 8.6 & 11.8 & 12.8 \\
NM-DualPCEN (5.0K)  & \textbf{10.1} & \textbf{17.2} & \textbf{18.9} \\
\bottomrule
\end{tabular}
\end{table}

At 0\,dB, NanoMamba achieves 17.2\,\%/K---4.5$\times$ that of DS-CNN-S (3.8\,\%/K) and 1.5$\times$ that of BC-ResNet-1 (11.8\,\%/K).
Even at the extreme $-15$\,dB condition, NanoMamba maintains 10.1\,\%/K versus 2.7\,\%/K for DS-CNN-S (3.7$\times$ advantage).
...
Our results reveal a nuanced picture of structural versus training-based noise robustness.
When all models are trained with noise augmentation, CNN baselines achieve higher absolute accuracy due to their larger parameter budgets (1.5--4.8$\times$).
However, NanoMamba's parameter efficiency advantage (4.6$\times$ over DS-CNN-S) indicates that its structural mechanisms---DualPCEN routing and SA-SSM adaptive dynamics---enable more effective use of each parameter for noise-robust computation.

The noise-type-dependent gap provides further insight.
Babble noise, with strong spectral structure, shows the smallest gap ($-$4.8\,\%p vs DS-CNN-S at 0\,dB, $-$2.5\,\%p vs BC-ResNet-1), confirming that DualPCEN's spectral-flatness routing is most effective when noise has distinctive spectral characteristics.
Broadband noise (white, pink) produces larger gaps, suggesting that future work on complementary routing features (e.g., temporal modulation index) could further improve DualPCEN's discrimination in these conditions.

At equal parameter budgets ($\sim$7.5K), NanoMamba's structural advantages---dynamic DualPCEN routing and adaptive SA-SSM dynamics---would be amplified, while CNN's fundamental limitation (frozen BatchNorm statistics at inference) remains unchanged regardless of scale.
This architectural asymmetry is the key motivation for structural noise robustness.
...
NanoMamba-Tiny-DualPCEN achieves 93.7\% clean accuracy and 85.1\% average accuracy at 0\,dB SNR with only \textbf{4,957~parameters}---delivering 4.6$\times$ higher parameter efficiency than DS-CNN-S (23.8K~params) and 1.5$\times$ higher than BC-ResNet-1 (7.5K~params).
The noise-type-dependent performance gap, where babble noise shows the smallest deficit ($-$4.8\,\%p vs DS-CNN-S), provides indirect evidence for DualPCEN's spectral-flatness-based routing effectiveness.
The ablation study confirms DualPCEN as the single largest contributor (+3.6\,\%p at 0\,dB), with architectural guarantees adding a further +0.7\,\%p without clean degradation.

These results establish that ultra-compact SSMs with structural noise adaptation represent a principled and parameter-efficient approach to noise-robust edge KWS.
While CNN baselines achieve higher absolute accuracy at 1.5--4.8$\times$ the parameter budget, NanoMamba's architectural innovations---dynamic per-input routing, adaptive state dynamics, and non-learnable stability guarantees---extract substantially more noise-robust computation per parameter, making it uniquely suited for the most extreme memory-constrained edge deployments.
