...
\midrule
Finetune (ours)           & 21,689  & TBD\%   & TBD\% \\
\textbf{NC-OPAL (ours)}  & 21,689  & \textbf{TBD\%} & \textbf{TBD\%} \\
\bottomrule
\end{tabular}
\end{table}

NC-OPAL achieves [TBD]\% ACC with 3$\times$ fewer parameters than prior methods, demonstrating that the method generalizes across both KWS and SLU tasks.
